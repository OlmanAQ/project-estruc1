...
bool insertSemester( int period, int year, string modality){  // Falta documentar (Olman)
    ...
    Semester* newSemester = new Semester(period, year, modality);  // The new node (Student) is created
